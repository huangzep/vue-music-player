	...
	<transition name="slide">
		<div class="user-center">
			...
			<div class="list-wrapper" ref="listWrapper">
				<scroll class="list-scroll" ref="favoriteList" v-if="currentIndex === 0" :data="favorite">
	            <div class="list-inner">
	              <song-list :songs="favorite" @select="selectSong"></song-list>
	            </div>
	          </scroll>
	          <scroll class="list-scroll" ref="searchList" v-if="currentIndex === 1" :data="playHistory">
	            <div class="list-inner">
